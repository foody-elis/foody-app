...
import 'package:foody_app/object_box/objectbox.g.dart';
    ...
    return FoodyLoaderOverlay(
      child: BlocConsumer<MenuBloc, MenuState>(
        listener: (context, state) {
          ...
          if (state.isFetchingDishes) {
            FoodyLoaderOverlay.of(context).show();
          } else {
            FoodyLoaderOverlay.of(context).hide();
          }
        },
                        ...
                        SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              Lottie.asset(
                                height: 120,
                                "assets/lottie/empty_menu_2.json",
                                animate: false,
                              ),
                              const Text(
